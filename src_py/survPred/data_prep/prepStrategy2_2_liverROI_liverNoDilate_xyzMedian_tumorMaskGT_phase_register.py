...
if __name__ == '__main__':
    ...
    save_root = os.path.join(config.proj_root, 'data_cleaned_CECT_annotations/liverROI_3d_liverNoDilate_xyzMedian_no_zscore_tumorMaskGT') # liverROI_3d_no_zscore, liverROI_3d_xyzSpacingMedian_no_zscore
