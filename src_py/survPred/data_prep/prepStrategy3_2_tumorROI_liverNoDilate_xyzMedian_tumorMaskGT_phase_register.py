...
def phases_register(caseName):
    ...
    pv_bbox = find_box_coords(pv_tumorMask_padded)
    art_bbox = find_box_coords(art_tumorMask_padded)
    ...
    #TUMOR_ROI
    # pv_out=pv_out*pv_tumorMask_out
    # art_out=art_out*art_tumorMask_out
...
if __name__ == '__main__':
    ...
    save_root = os.path.join(config.proj_root, 'data_cleaned_CECT_annotations/tumorROI_3d_liverNoDilate_xyzMedian_no_zscore') # liverROI_3d_no_zscore, liverROI_3d_xyzSpacingMedian_no_zscore
    # liver_root = os.path.join(config.proj_root, 'data_cleaned_CECT_annotations/liverROI_3d_liverNoDilate_xyzMedian_no_zscore_tumorMaskByModel')
    ...
    # outputs
    save_path = os.path.join(save_root, 'alligned_bbx/')
